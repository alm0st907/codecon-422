...
DROP DATABASE IF EXISTS TestCodeconDB;
go

CREATE DATABASE TestCodeconDB
GO
...
INSERT INTO [User] VALUES('User1', 'user1@email.com', '12345', 0);
INSERT INTO [User] VALUES('User2', 'user2@email.com', 'abcde', 0);
INSERT INTO [User] VALUES('User3', 'user3@email.com', 'zyxwv', 0);
